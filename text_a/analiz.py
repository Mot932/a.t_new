...
class TextAnalyser:
    def __init__(self, file_name=None, pos_list=['VERB', 'NOUN'], chislo=None) -> None:
        """
    ...
    def create_wordcloud(self) -> None:
        ...
        self.wordcloud = WordCloud(width=800, height=400, background_color='white').generate_from_frequencies(dict(top_10_words))
